...
namespace mnist {
    ...
    std::vector<std::vector<Pixel>> read_training_images() {
        return read_mnist_image_file<Pixel>("C:/Users/grain/Desktop/mnist/train-images-idx3-ubyte");
    }
    ...
    std::vector<std::vector<Pixel>> read_test_images() {
        return read_mnist_image_file<Pixel>("C:/Users/grain/Desktop/mnist/t10k-images-idx3-ubyte");
    }
    ...
    std::vector<Label> read_training_labels() {
        return read_mnist_label_file<Label>("C:/Users/grain/Desktop/mnist/train-labels-idx1-ubyte");
    }
    ...
    std::vector<Label> read_test_labels() {
        return read_mnist_label_file<Label>("C:/Users/grain/Desktop/mnist/t10k-labels-idx1-ubyte");
    }
